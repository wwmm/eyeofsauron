...
PROJECT="eyeofsauron"	# project name
BUGADDR="https://github.com/wwmm/eyeofsauron/issues"	# MSGID-Bugs
...
cp src/contents/com.github.wwmm.eyeofsauron.desktop.template ${WDIR}
cd ${WDIR}
intltool-extract --quiet --type=gettext/ini com.github.wwmm.eyeofsauron.desktop.template
echo "com.github.wwmm.eyeofsauron.desktop.template.h" >> ${WDIR}/infiles.list
...
cd ${WDIR}
intltool-merge --quiet --desktop-style ${BASEDIR}/po com.github.wwmm.eyeofsauron.desktop.template ${BASEDIR}/src/contents/com.github.wwmm.eyeofsauron.desktop
...
rm infiles.list
rm rc.cpp
rm com.github.wwmm.eyeofsauron.desktop.template
rm com.github.wwmm.eyeofsauron.desktop.template.h
